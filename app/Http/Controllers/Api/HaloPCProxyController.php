...
class HaloPCProxyController extends Controller
{
    ...
    public function list()
    {
        ...
        try 
        {
            ...
            $response = Http::timeout(30)->get("{$this->pythonApiUrl}/api/halopc");
            $out = $response->body();
        ...
        {
            return response()->json(['error' => 'Failed to fetch halo pc list', 'message' => $e->getMessage()], 503);
        }
    }
}